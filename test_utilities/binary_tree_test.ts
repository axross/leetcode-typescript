...
import { createBinaryTreeNode } from "./binary_tree.ts";
  ...
  test("createBinaryTreeNode() returns a BinaryTreeNode", () => {
    assertEquals(createBinaryTreeNode([1, 2, 3]), { val: 1, left: { val: 2, left: null, right: null }, right: { val: 3, left: null, right: null }});
    assertEquals(createBinaryTreeNode([1, null, 2, 3]), { val: 1,
      left: null,
      right: {
        val: 2,
        left: {
